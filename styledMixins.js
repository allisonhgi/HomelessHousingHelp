...
export const RobotoMediumSummerGreen436px = css`
  color: var(--summer-green);
  font-family: var(--font-family-roboto);
  font-size: 43.6px;
  font-weight: 500;
...
export const RobotoMediumBlack50px = css`
  color: var(--black);
  font-family: var(--font-family-roboto);
  font-size: 50px;
  font-weight: 500;
...
export const RobotoMediumWhite20px = css`
  color: var(--white);
  font-family: var(--font-family-roboto);
  font-size: 20px;
  font-weight: 500;
...
export const LibrebaskervilleNormalWhite195px = css`
  color: var(--white);
  font-family: var(--font-family-libre_baskerville);
  font-size: 19.5px;
  font-weight: 400;
...
export const LibrebaskervilleNormalBlack29px = css`
  color: var(--black);
  font-family: var(--font-family-libre_baskerville);
  font-size: 29px;
  font-weight: 400;
...
export const LibrebaskervilleNormalWhite20px = css`
  color: var(--white);
  font-family: var(--font-family-libre_baskerville);
  font-size: 20px;
  font-weight: 400;
