...
import "./VoucherToolV3Disqualifications4.css";

class VoucherToolV3Disqualifications4 extends React.Component {
  render() {
    const {
      voucherTool,
    ...
    return (
      <div className="container-center-horizontal">
        <div className="voucher-tool-v3-disqualifications-4 screen">
          <OverlapGroup3>
            <Logo />
          ...
          <FlexRow>
            <FlexCol>
              <FlexRow1>
                <TutorialButtons src="/img/tutorial-buttons-78@2x.svg" />
                <OverlapGroup2>
                  ...
                  <FlexRow2>
                    ...
                    <FlexCol2>
                      ...
                      <Link to="/voucher-tool-v3-disqualifications" className="align-self-flex-center">
                        <NobodyInTheApplyi>
              ...
              <Link to="/voucher-tool-v3-eligibility-questions">
                <TutorialButtons1 src="/img/tutorial-buttons-79@2x.svg" />
              </Link>
            </FlexCol>
            <Link to="/voucher-tool-v3-required-paperwork">
              <TutorialButtons2 src="/img/tutorial-buttons-77@2x.svg" />
            </Link>
          </FlexRow>
        </div>
      </div>
...
export default VoucherToolV3Disqualifications4;
