        ...
        <div className="voucher-tool-v3-disqualifications-4 screen">
          ...
          <TutorialButtonsContainer>
            <Link to="/voucher-tool-v3-eligibility-questions" className="align-self-flex-end">
              <TutorialButtons src="/img/tutorial-buttons-79@2x.svg" />
            </Link>
            <Link to="/voucher-tool-v3-disqualifications-notice-page-1">
              <TutorialButtons1 src="/img/tutorial-buttons-77@2x.svg" />
            </Link>
          </TutorialButtonsContainer>
        </div>
      </div>
