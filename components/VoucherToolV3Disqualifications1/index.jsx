      ...
      <div className="container-center-horizontal">
        <div className="voucher-tool-v3-disqualifications-1 screen">
          ...
          <FlexRow>
            <FlexCol>
              <FlexRow1>
                <TutorialButtons src="/img/tutorial-buttons-69@2x.svg" />
                <OverlapGroup1>
              ...
              <Link to="/voucher-tool-v3-eligibility-questions">
                <TutorialButtons1 src="/img/tutorial-buttons-70@2x.svg" />
              </Link>
            </FlexCol>
            <Link to="/voucher-tool-v3-required-paperwork">
              <TutorialButtons2 src="/img/tutorial-buttons-68@2x.svg" />
            </Link>
          </FlexRow>
        </div>
      </div>
