...
import "./VoucherToolV3Eligibility6.css";

class VoucherToolV3Eligibility6 extends React.Component {
  render() {
    const {
      voucherTool,
      inOrderToBeEligi,
    ...
    return (
      <div className="container-center-horizontal">
        <div className="voucher-tool-v3-eligibility-6 screen">
          <OverlapGroup2>
            <Logo />
            <HomePageLink />
            <MoreResources />
          ...
          <FlexRow>
            <TutorialButtonsContainer>
              <TutorialButtons src="/img/tutorial-buttons-93@2x.svg" />
              <Link to="/voucher-tool-v3-disclaimers">
                <TutorialButtons1 src="/img/tutorial-buttons-94@2x.svg" />
              </Link>
            </TutorialButtonsContainer>
            <FlexCol>
              ...
              <OverlapGroup1>
                ...
                <FlexRow2>
                  ...
                  <Link to="/voucher-tool-v3-eligibility-questions">
                    <StalkingOrHumanTrafficking>{stalkingOrHumanTrafficking}</StalkingOrHumanTrafficking>
                  </Link>
                </FlexRow2>
                <FlexRow2>
                  <Rectangle116></Rectangle116>
            ...
            <Link to="/voucher-tool-v3-disqualifications">
              <TutorialButtons2 src="/img/tutorial-buttons-92@2x.svg" />
            </Link>
          </FlexRow>
        </div>
      </div>
...
const StalkingOrHumanTrafficking = styled.div`
  ${LibrebaskervilleNormalBlack28px}
  width: 853px;
  min-height: 40px;
  margin-left: 12px;
...
export default VoucherToolV3Eligibility6;
