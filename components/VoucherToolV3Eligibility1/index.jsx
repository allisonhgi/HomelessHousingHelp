        ...
        <div className="voucher-tool-v3-eligibility-1 screen">
          ...
          <FlexRow>
            <TutorialButtonsContainer>
              <TutorialButtons src="/img/tutorial-buttons-87@2x.svg" />
              <Link to="/voucher-tool-v3-disclaimers">
                <TutorialButtons1 src="/img/tutorial-buttons-88@2x.svg" />
              </Link>
            </TutorialButtonsContainer>
            <FlexCol>
            ...
            <Link to="/voucher-tool-v3-disqualifications">
              <TutorialButtons2 src="/img/tutorial-buttons-86@2x.svg" />
            </Link>
          </FlexRow>
        </div>
      </div>
