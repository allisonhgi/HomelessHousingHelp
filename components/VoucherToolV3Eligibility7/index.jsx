...
import "./VoucherToolV3Eligibility7.css";

class VoucherToolV3Eligibility7 extends React.Component {
  render() {
    const {
      voucherTool,
      inOrderToBeEligi,
    ...
    return (
      <div className="container-center-horizontal">
        <div className="voucher-tool-v3-eligibility-7 screen">
          <OverlapGroup1>
            <Logo />
            <HomePageLink />
            <MoreResources />
          ...
          <FlexRow>
            <TutorialButtonsContainer>
              <TutorialButtons src="/img/tutorial-buttons-90@2x.svg" />
              <Link to="/voucher-tool-v3-disclaimers">
                <TutorialButtons1 src="/img/tutorial-buttons-91@2x.svg" />
              </Link>
            </TutorialButtonsContainer>
            <FlexCol>
            ...
            <Link to="/voucher-tool-v3-disqualifications-notice-page">
              <TutorialButtons2 src="/img/tutorial-buttons-89@2x.svg" />
            </Link>
          </FlexRow>
        </div>
      </div>
...
export default VoucherToolV3Eligibility7;
