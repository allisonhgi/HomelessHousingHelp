...
import "./VoucherToolV3DisqualificationsNotic2.css";

class VoucherToolV3DisqualificationsNotic2 extends React.Component {
  render() {
      ...
      <div className="container-center-horizontal">
        <div className="voucher-tool-v3-disqualifications-notice-page screen">
          ...
          <TutorialButtonsContainer>
            <Link to="/voucher-tool-v3-eligibility-7" className="align-self-flex-end">
...
export default VoucherToolV3DisqualificationsNotic2;
