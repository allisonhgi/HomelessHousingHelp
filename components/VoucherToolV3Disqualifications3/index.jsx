      ...
      <div className="container-center-horizontal">
        <div className="voucher-tool-v3-disqualifications-3 screen">
          ...
          <FlexRow>
            <FlexCol>
              <FlexRow1>
                <TutorialButtons src="/img/tutorial-buttons-75@2x.svg" />
                <OverlapGroup1>
              ...
              <Link to="/voucher-tool-v3-eligibility-questions">
                <TutorialButtons1 src="/img/tutorial-buttons-76@2x.svg" />
              </Link>
            </FlexCol>
            <Link to="/voucher-tool-v3-required-paperwork">
              <TutorialButtons2 src="/img/tutorial-buttons-74@2x.svg" />
            </Link>
          </FlexRow>
        </div>
      </div>
