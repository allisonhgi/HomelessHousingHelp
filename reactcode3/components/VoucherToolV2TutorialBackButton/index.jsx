        ...
        <div className="voucher-tool-v2-tutorial-back-button screen">
          <div className="flex-col-42">
            ...
            <div className="overlap-group4-24">
              <div className="voucher-tool-34 header-2">{voucherTool}</div>
          ...
          <div className="flex-row-93">
            <div className="overlap-group3-32">
              ...
              <Link to="/voucher-tool-v2-tutorial-audio-button">
                <img className="tutorial-buttons-130" src="/img/tutorial-buttons-41@2x.svg" />
              </Link>
            </div>
            <Property1SaveData className={property1SaveDataProps.className} />
            <Link to="/voucher-tool-v2-tutorial-save-data-button">
              <img className="tutorial-buttons-131" src="/img/tutorial-buttons-40@2x.svg" />
            </Link>
          </div>
        </div>
      </div>
