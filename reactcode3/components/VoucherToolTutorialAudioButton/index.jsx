      ...
      <div className="container-center-horizontal">
        <div className="voucher-tool-tutorial-audio-button screen">
          <div className="flex-col-7">
            <div className="flex-row-8">
              ...
              <div className="flex-col-8 roboto-normal-summer-green-35px">
                ...
                <div className="more-resources-31">{moreResources}</div>
              </div>
            </div>
          ...
          <div className="tutorial-buttons-container-2">
            <img className="tutorial-buttons-66" src="/img/tutorial-buttons-7@2x.svg" />
            <Property1SaveData />
            <Link to="/voucher-tool-tutorial-back-button">
              <img className="tutorial-buttons-67" src="/img/tutorial-buttons-6@2x.svg" />
            </Link>
          </div>
        </div>
      </div>
