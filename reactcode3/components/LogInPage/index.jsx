        ...
        <div className="log-in-page screen">
          <div className="flex-row-16">
            ...
            <div className="flex-col-10">
              <Link to="/resources">
                <div className="more-resources-36 roboto-normal-summer-green-35px">{moreResources}</div>
              </Link>
              <div className="voucher-tools-2 roboto-normal-summer-green-35px">{voucherTools}</div>
            </div>
          </div>
          <div className="log-in-2 header-2">{logIn1}</div>
          ...
          <Link to="/account-page">
            <div className="profile-completion">
              <div className="overlap-group1-48">
                <div className="log-in-3 roboto-medium-white-25px">{logIn2}</div>
              </div>
            </div>
          </Link>
        </div>
