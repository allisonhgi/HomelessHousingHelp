      ...
      <div className="user-menu-pop-up-logged-in-1">
        <div className="overlap-group-78">
          ...
          <div className="overlap-group2-34">
            ...
            <Link to="/account-page-alt-v2-my-resources-click">
              <div className="view-2 roboto-normal-white-20px">{view1}</div>
            </Link>
          ...
          <div className="overlap-group3-18">
            ...
            <div className="overlap-group-77">
              <Link to="/account-page-alt-v2-1">
                <div className="view-1 roboto-normal-white-20px">{view2}</div>
              </Link>
              <Link to="/account-page-alt-v2-1">
                <div className="evaarrow-ios-forward-outline">
                  <img className="vector-127" src={vector3} />
                </div>
              </Link>
            </div>
          </div>
          <div className="overlap-group1-55">
            ...
            <Link to="/housing-tool" className="align-self-flex-center">
              <div className="view-3 roboto-normal-white-20px">{view3}</div>
            </Link>
          </div>
          <div className="overlap-group4-13">
            ...
            <div className="overlap-group-77">
              <Link to="/voucher-tool-v2-starting-screen">
                <div className="view-1 roboto-normal-white-20px">{view4}</div>
              </Link>
              <Link to="/voucher-tool-v2-starting-screen">
                <div className="evaarrow-ios-forward-outline">
