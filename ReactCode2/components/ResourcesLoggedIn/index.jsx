    ...
    return (
      <div className="container-center-horizontal">
        <div className="resources-logged-in screen">
          ...
          <div className="more-resources-67 header-2">{moreResources}</div>
          ...
          <div className="resource-section-14">
            <div className="overlap-group1-53">
              <div className="university-district-food-bank-4 roboto-medium-white-40px">
                {universityDistrictFoodBank}
              </div>
              ...
              <div className="overlap-group-75">
                <div className="add-to-my-resources-8">{addToMyResources}</div>
              </div>
            </div>
          </div>
