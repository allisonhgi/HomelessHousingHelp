        ...
        <div className="voucher-tool-v3-required-paperwork-1 screen">
          <div className="flex-col-33">
            ...
            <div className="overlap-group7-2">
              <div className="voucher-tool-16 header-2">{voucherTool}</div>
            ...
            <div className="flex-row-53">
              ...
              <div className="text-info-6 border-1px-black-2">
                <div className="overlap-group5-8">
                  <div className="no-documents-are-nee-4 librebaskerville-normal-black-27px">
          ...
          <div className="tutorial-buttons-container-15">
            <Link to="/voucher-tool-v2-disqualifications-notice-page" className="align-self-flex-end">
              <img className="tutorial-buttons-95" src="/img/tutorial-buttons-21@2x.svg" />
            </Link>
            <Property1SaveData className={property1SaveDataProps.className} />
            <Link to="/voucher-tool-v2-next-steps">
              <img className="tutorial-buttons-96" src="/img/tutorial-buttons-20@2x.svg" />
            </Link>
          </div>
        </div>
      </div>
