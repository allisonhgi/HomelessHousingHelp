        ...
        <Switch>
          ...
          <Route path="/phone-pop-up-v2-phone-pop-up-default">
            <PhonePopUpV2PhonePopUpDefault
              phonePopUpV2PhonePopUpDefault2Props={
                phonePopUpV2PhonePopUpDefaultData.phonePopUpV2PhonePopUpDefault2Props
              }
            />
          </Route>
...
const phonePopUpV2PhonePopUpDefault2Data = {
...
const phonePopUpV2PhonePopUpDefaultData = {
    phonePopUpV2PhonePopUpDefault2Props: phonePopUpV2PhonePopUpDefault2Data,
};
...
const resourceAddedOrNotNotAdded31Data = {
    housingChoiceVouchers: "Housing Choice Vouchers",
    theHousingChoiceV: "The Housing Choice Voucher program (formerly Section 8), helps low-income families, individuals, seniors and people with disabilities pay their monthly rent in privately owned apartments or houses.",
};

const resourceAddedOrNotResourceAddedOrNo21Data = {
...
const resourcesV3Data = {
    moreResources: "More Resources",
    ifYouHaveAlready: "If you have already used our voucher tools and are interested in other resources, you’re in the right place! Click on any resource to learn more.",
    otherVoucherPrograms: "Other Voucher Programs",
    housingChoiceVouchers: "Housing Choice Vouchers",
    theHousingChoiceV: "The Housing Choice Voucher program (formerly Section 8), helps low-income families, individuals, seniors and people with disabilities pay their monthly rent in privately owned apartments or houses.",
    foodAndShelterResources: "Food and Shelter Resources",
    temporaryHousingResources: "Temporary Housing Resources",
    resourceAddedOrNotNotAdded31Props: resourceAddedOrNotNotAdded31Data,
    resourceAddedOrNotResourceAddedOrNo2Props: resourceAddedOrNotResourceAddedOrNo21Data,
...
const resourceAddedOrNotNotAdded33Data = {
    housingChoiceVouchers: "Example",
    theHousingChoiceV: "Test description",
    className: "resource-section-10",
};

const resourceAddedOrNotResourceAddedOrNo22Data = {
    universityDistrictFoodBank: "Test",
    ourMissionIsToBu: "Test description",
};

const resourceAddedOrNotNotAdded34Data = {
    housingChoiceVouchers: "Test",
    theHousingChoiceV: "Test description",
...
const resourcesV32Data = {
    ...
    ifYouHaveReceived: "If you have received your voucher and are interested in other resources, you’re in the right place! Click on any resource to learn more.",
    housingSearchResources: "Housing Search Resources",
    housingChoiceVouchers: "Housing Choice Vouchers",
    theHousingChoiceV: "The Housing Choice Voucher program (formerly Section 8), helps low-income families, individuals, seniors and people with disabilities pay their monthly rent in privately owned apartments or houses.",
    test1: "Test",
    test2: "Test",
    resourceAddedOrNotNotAdded31Props: resourceAddedOrNotNotAdded33Data,
    resourceAddedOrNotResourceAddedOrNo2Props: resourceAddedOrNotResourceAddedOrNo22Data,
    resourceAddedOrNotNotAdded32Props: resourceAddedOrNotNotAdded34Data,
};

const property1Audio35Data = {
    className: "tutorial-buttons-37",
};
...
const voucherToolV2TutorialAudioButtonData = {
    property1AudioProps: property1Audio35Data,
