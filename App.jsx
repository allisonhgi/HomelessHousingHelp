...
const voucherToolV3RequiredPaperworkPOIData = {
    ...
    spanText8: <React.Fragment>Additionally, households with 30% area median income or below will be prioritized in their voucher applications.<br /></React.Fragment>,
